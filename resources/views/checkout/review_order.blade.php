            ...
            <form action="{{url('/submit-order')}}" method="post" class="form-horizontal">
                ...
                <div class="col-sm-12">
                    ...
                    <section id="cart_items">
                        ...
                        <div class="table-responsive cart_info">
                            <table class="table table-condensed">
                                ...
                                @foreach($cart_datas as $cart_data)
                                    ...
                                    <td class="cart_price">
                                        <p>Rp{{$cart_data->price}}Jt</p>
                                    </td>
                                    <td class="cart_quantity">
                                        <p>{{$cart_data->quantity}}</p>
                                    </td>
                                    <td class="cart_total">
                                        <p class="cart_total_price">Rp {{$cart_data->price*$cart_data->quantity}}Jt</p>
                                    </td>
                                </tr>
                                @endforeach
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <table class="table table-condensed total-result">
                                            <tr>
                                                ...
                                                <td>Rp {{$total_price}}Jt</td>
                                            </tr>
                                            @if(Session::has('discount_amount_price'))
                                                <tr class="shipping-cost">
                                                    <td>Coupon Discount</td>
                                                    <td>Rp {{Session::get('discount_amount_price')}}Jt</td>
                                                </tr>
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span>Rp {{$total_price-Session::get('discount_amount_price')}}Jt</span></td>
                                                </tr>
                                            @else
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span>Rp {{$total_price}}Jt</span></td>
                                                </tr>
                                            @endif
                                        </table>
                                    </td>
                        ...
                        <span>
                            <label><input type="radio" name="payment_method" value="COD" checked> Debit</label>
                        </span>
                        <span>
                            <label><input type="radio" name="payment_method" value="COD" checked> Kredit</label>
                        </span>
